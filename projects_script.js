...
const images = [
    { filename: './images/static_qr_code.jpg',
      ...
      description: 'The scope of this project was to create a static QR code page.',
      alt: 'QR-Card',
    ...
    { filename: './images/static_calendar.jpg',
      ...
      description: 'This project represents a static web page containing a calendar.',
      alt: 'Calendar',
    ...
    { filename: './images/hex_color_generator_js.jpg',
      ...
      description: 'The goal of this project was to build a random color generator, that when pressed the button on the page it would generate a color and its corresponding hexadecimal value.',
    ...
    { filename: './images/digital_clock_js.jpg',
      title: 'Digital Clock',
      description: 'With the help of Javascript this projects acts like a clock, by that I mean it display the current time on the web page.',
      alt: 'Digital Clock',
    ...
    { filename: './images/image_carousel.png',
      ...
      description: 'This is a simple image carousel, the user can navigate between the predefined images by using the available buttons on the web page.',
      alt: 'Image Carousel',
    ...
    { filename: './images/weather_app_react.jpg',
      title: 'Weather App',
      description: 'The objective of this project was to design a network of weather stations that send measured data to a master device that acts like a gateway which upon receiving the information it transmits it to a realtime database made in Firebase Realtime Database. I tried using as an experimental demonstration 2 ESP32\'s that each had a LoRa module to facilitate communication between them. In order to see the measurements plus a timestamp I had built a web app with React and connected it to the database.',
